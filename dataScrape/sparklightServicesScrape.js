...
for (let i = 0; i < list.length; i++) {
  ...
  let dueDate = list[i].cells[9].textContent;
  let dropDate = list[i].cells[10].textContent;
  let cableType = list[i].cells[11].textContent;
  let completed = list[i].cells[12].textContent;
  let lineFootage = list[i].cells[13].textContent; //
  let boreFootage = list[i].cells[14].textContent; //
  let pedestal = list[i].cells[15].textContent; //
  let expedite = list[i].cells[16].textContent; //
  let rushApproved = list[i].cells[17].textContent; //
  let serviceType = list[i].cells[18].textContent;
  let status = list[i].cells[19].textContent;
  let expireStatus = list[i].cells[20].textContent;
  let work = list[i].cells[21].textContent;
  let jobPhotos = list[i].cells[22].textContent;
  let feedbackRating = list[i].cells[23].textContent;
  let spotsNotExpired = list[i].cells[24].textContent;
  let spot = list[i].cells[25].textContent;
  let spotStatus = list[i].cells[26].textContent;
  let damages = list[i].cells[27].textContent;
